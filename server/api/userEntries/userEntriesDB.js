(function () {
    ...
    var userEntriesDB = function () {
        return {
            userEntriesDB: async function (req, successFn, errFn) {
                var message;
                ...
                dataAccessLayer.connectDb(req, errFn, procNames.proc_userentries, inputObject, errors.proc_userentries, function (result) {
